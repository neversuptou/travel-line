...
const Hero = () => {
  return (
    ...
    gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row'>
      ...
      <p className='regular-16 mt-6 text-gray-30 xl:max-w-[520px] lg:max-w-[400px] '>
        We want to be on each of your journeys seeking the satisfaction
         ...
         <div className="my-11 flex flex-wrap gap-5">
          ...
          <p className='bold-16 lg:bold-20 text-blue-70'>
            198k
            <span className='regular-16 lg:legular-20 ml-2'>Excelent Reviews</span>
            </p>
         </div>
      ...
      <div className='relative flex flex-1 items-start'>
          <div className='relative z-20 flex wp-[268px] flex-col gap-8 
